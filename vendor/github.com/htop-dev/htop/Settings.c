...
static void Settings_defaultMeters(Settings* this, const Machine* host) {
   ...
   this->hColumns[0].names[2] = xStrdup("Blank");
   ...
   this->hColumns[1].names[1] = xStrdup("Features");
   this->hColumns[1].modes[1] = TEXT_METERMODE;
   this->hColumns[1].names[2] = xStrdup("Blank");
   this->hColumns[1].modes[2] = TEXT_METERMODE;
   this->hColumns[1].names[3] = xStrdup("TargetValue");
